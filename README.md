...
- Phase 1 Report: [Link](./docs/Phase1-Report.pdf)
- Phase 2 Report: [Link](./docs/Phase2-Report.pdf)
- Experiment results, trained model, and output images: [Link](https://drive.google.com/drive/folders/17bD0_BudCUKC-7Z7y7hEhKjZ0rQ0ZGBE?usp=share_link)
- Google Colab environment: [Link](https://drive.google.com/file/d/1x_5paAO4z3stNoaQx8s9vKgx-FHrouk0/view?usp=sharing)
- Kaggle training & evaluation environment: [Link](https://www.kaggle.com/code/alisedaghi/runner)
- Kaggle pre-trained model evaluation environment: [Link](https://www.kaggle.com/code/zohrehbodaghi/evaluate)
- BraTS dataset: [Link](https://drive.google.com/drive/folders/1-_V-q80bmAGUhvyWT13rca4eEL-C7oXC?usp=share_link)
- Pretrained models (SegFormer, HRNet, ResNet): [Link](https://drive.google.com/drive/folders/1iS9GHo627a81gbF7tTFBLHZQmqIMXUht?usp=share_link)
